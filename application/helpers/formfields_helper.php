 ...
 */
if (!function_exists('makeFileInputBox')) {

    function makeFileInputBox($label, $name, $value, $explain = "", $maxlen = 40, $size = 25, $disabled = false) {
        $CI = &get_instance();
        $parms = array(
            'label' => $label,
            'name' => $name,
        ...
        return $CI->parser->parse('_fields/inputbox', $parms, true);
    }
